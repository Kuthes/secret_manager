...
var client_references_default = {
	"73d7a23e5015": async () => {
		const m = await import("./assets/page-D5VwwhxJ.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"a54e148db4d5": async () => {
		const m = await import("./assets/error-boundary-DW6Xqgv9.js");
		return {
			get "ErrorBoundary"() {
	...
	"aa7f0c7bab4d": async () => {
		const m = await import("./assets/layout-segment-context-BBn8J15I.js");
