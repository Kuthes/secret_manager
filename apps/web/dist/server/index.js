globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/layout-segment-context-BbNuwIJY.js","assets/page-epR9Bxoy.js"];
...
function getDraftSecret() {
	return "c6d6a70e-dfc1-4080-b9f0-3541643cfb52";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "2d908191-c7c2-48e2-ac0f-60fc0e146a3c";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "2d908191-c7c2-48e2-ac0f-60fc0e146a3c") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "2d908191-c7c2-48e2-ac0f-60fc0e146a3c",
		rootBoundaryId
	});
}
/**
